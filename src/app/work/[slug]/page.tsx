        ...
        <div className="grid-container w-full">
          <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-12 lg:col-span-8">
              ...
              >
                <div className={`bauhaus-line-red w-16 mb-8 ${colorMap[study.color].replace('bg-', 'bg-')}`} style={{ backgroundColor: study.color === 'red' ? '#FF0000' : study.color === 'blue' ? '#0047FF' : study.color === 'yellow' ? '#FFCC00' : '#000000' }} />
      ...
      <section className="py-grid-3 border-t-2 border-bauhaus-black">
        <div className="grid-container">
          <div className="grid grid-cols-12 gap-6">
            ...
            >
              <div>
                <span className="text-caption text-bauhaus-gray block mb-2">
                  ROLE
                </span>
              ...
              <ul className="space-y-6">
                {study.learnings.map((learning, index) => (
                  <motion.li
                    ...
                    transition={{ duration: 0.6, delay: index * 0.1 }}
                  >
                    <span className={`${textColorMap[study.color]} text-heading`}>
                      →
                    </span>
        ...
        <div className="grid-container">
          ...
          >
            ...
            >
              ...
              <p className="text-subheading text-bauhaus-gray mt-2">
                {nextStudy.subtitle}
              </p>
            </Link>
          </motion.div>
